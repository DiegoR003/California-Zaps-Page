...
;(function($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('#site-logo').find('img').attr( {src:'assets/img/logo.png',width:'105',height:'29'} );
              $('.logo-dark').find('img').attr( {src:'assets/img/logo.png',width:'105',height:'29'} );
          }   
      };
    ...
    $(document).on('click', '.mobile-button', function() {
        ...
        $('#main-nav-mobi').prepend('<div class="mobile-button style-2"><i class="fal fa-times"></i></div>');
        $('#main-nav-mobi').slideToggle(500);
    })
