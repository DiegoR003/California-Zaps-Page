...
if (!validarVariable($nombre)|| !validarVariable($correo) || !validarVariable($tel) || !validarVariable($asunto) || !validarVariable($msj)) {
  mandarError("1");
}

$correo_nuevo = new Correo("lucyaldia@hotmail.com", $nombre.' ha enviado un nuevo mensaje');
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">California Zap´s Copyright © 2024 Todos los Derechos Reservados.</span>
                      <br>Los Cabos, B.C.S. México.
                    </td>
                  </tr>
                  <tr>
                    <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      Powered by <a href="#" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;"><strong>Banana Marketing Group</strong>.</a>
                    </td>
                  </tr>
                </table>
              </div>
